...
export namespace window_proc {
	...
	using WM_CHAR_callback_T = std::function<result_type(wchar_t, const WindowsKeyData&)>;
	...
	using WM_KEYDOWN_callback_T = std::function<result_type(win_cpp::VirtualKeysStandardSet, const WindowsKeyData&)>;
	using WM_KEYFIRST_callback_T = std::function<result_type()>;
	using WM_KEYLAST_callback_T = std::function<result_type()>;
	using WM_KEYUP_callback_T = std::function<result_type(win_cpp::VirtualKeysStandardSet, const WindowsKeyData&)>;
	using WM_KILLFOCUS_callback_T = std::function<result_type()>;
	using WM_LBUTTONDBLCLK_callback_T = std::function<result_type()>;
	using WM_LBUTTONDOWN_callback_T = std::function<result_type(const std::pair<short, short>&, win_cpp::MouseKeysFlags)>;
	using WM_LBUTTONUP_callback_T = std::function<result_type(const std::pair<short, short>&, win_cpp::MouseKeysFlags)>;
	using WM_MBUTTONDBLCLK_callback_T = std::function<result_type()>;
	using WM_MBUTTONDOWN_callback_T = std::function<result_type(const std::pair<short, short>&, win_cpp::MouseKeysFlags)>;
	using WM_MBUTTONUP_callback_T = std::function<result_type(const std::pair<short, short>&, win_cpp::MouseKeysFlags)>;
	...
	using WM_RBUTTONDOWN_callback_T = std::function<result_type(const std::pair<short, short>&, win_cpp::MouseKeysFlags)>;
	using WM_RBUTTONUP_callback_T = std::function<result_type(const std::pair<short, short>&, win_cpp::MouseKeysFlags)>;
	...
	using WM_SYSCHAR_callback_T = std::function<result_type(wchar_t, const WindowsKeyData&)>;
	...
	using WM_SYSKEYDOWN_callback_T = std::function<result_type(win_cpp::VirtualKeysStandardSet, const WindowsKeyData&)>;
	using WM_SYSKEYUP_callback_T = std::function<result_type(win_cpp::VirtualKeysStandardSet, const WindowsKeyData&)>;
	...
	using WM_UNICHAR_callback_T = std::function<result_type(unsigned codepoint, const window_proc::WindowsKeyData& data)>;
	...
	using WM_XBUTTONDOWN_callback_T = std::function<result_type(unsigned, const std::pair<short, short>&, win_cpp::MouseKeysFlags)>;
	using WM_XBUTTONUP_callback_T = std::function<result_type(unsigned, const std::pair<short, short>&, win_cpp::MouseKeysFlags)>;
	...
	struct CallbackHolder {
		...
		WM_CHAR_callback_T WM_CHAR_callback = [](wchar_t, const WindowsKeyData&) constexpr noexcept -> result_type { return std::nullopt; };
		...
		WM_KEYDOWN_callback_T WM_KEYDOWN_callback = [](win_cpp::VirtualKeysStandardSet, const WindowsKeyData&) constexpr noexcept -> result_type { return std::nullopt; };
		...
		WM_KEYUP_callback_T WM_KEYUP_callback = [](win_cpp::VirtualKeysStandardSet, const WindowsKeyData&) constexpr noexcept -> result_type { return std::nullopt; };
		...
		WM_LBUTTONDOWN_callback_T WM_LBUTTONDOWN_callback = [](const std::pair<short, short>&, win_cpp::MouseKeysFlags) constexpr noexcept -> result_type { return std::nullopt; };
		WM_LBUTTONUP_callback_T WM_LBUTTONUP_callback = [](const std::pair<short, short>&, win_cpp::MouseKeysFlags) constexpr noexcept -> result_type { return std::nullopt; };
		WM_MBUTTONDBLCLK_callback_T WM_MBUTTONDBLCLK_callback = []() constexpr noexcept -> result_type { return std::nullopt; };
		WM_MBUTTONDOWN_callback_T WM_MBUTTONDOWN_callback = [](const std::pair<short, short>&, win_cpp::MouseKeysFlags) constexpr noexcept -> result_type { return std::nullopt; };
		WM_MBUTTONUP_callback_T WM_MBUTTONUP_callback = [](const std::pair<short, short>&, win_cpp::MouseKeysFlags) constexpr noexcept -> result_type { return std::nullopt; };
		...
		WM_RBUTTONDOWN_callback_T WM_RBUTTONDOWN_callback = [](const std::pair<short, short>&, win_cpp::MouseKeysFlags) constexpr noexcept -> result_type { return std::nullopt; };
		WM_RBUTTONUP_callback_T WM_RBUTTONUP_callback = [](const std::pair<short, short>&, win_cpp::MouseKeysFlags) constexpr noexcept -> result_type { return std::nullopt; };
		...
		WM_SYSCHAR_callback_T WM_SYSCHAR_callback = [](wchar_t, const WindowsKeyData&) constexpr noexcept -> result_type { return std::nullopt; };
		...
		WM_SYSKEYDOWN_callback_T WM_SYSKEYDOWN_callback = [](win_cpp::VirtualKeysStandardSet, const WindowsKeyData&) constexpr noexcept -> result_type { return std::nullopt; };
		WM_SYSKEYUP_callback_T WM_SYSKEYUP_callback = [](win_cpp::VirtualKeysStandardSet, const WindowsKeyData&) constexpr noexcept -> result_type { return std::nullopt; };
		...
		WM_UNICHAR_callback_T WM_UNICHAR_callback = [](unsigned codepoint, const window_proc::WindowsKeyData& data) constexpr noexcept -> result_type { return std::nullopt; };
		...
		WM_XBUTTONDOWN_callback_T WM_XBUTTONDOWN_callback = [](unsigned, const std::pair<short, short>&, win_cpp::MouseKeysFlags) constexpr noexcept -> result_type { return std::nullopt; };
		WM_XBUTTONUP_callback_T WM_XBUTTONUP_callback = [](unsigned, const std::pair<short, short>&, win_cpp::MouseKeysFlags) constexpr noexcept -> result_type { return std::nullopt; };
